...
- 本项目是**学习交流用途的技术研究产物**（"学习版"），仅供个人学习、研究与体验使用，**不得用于任何商业用途、公开传播或二次分发**。
- 游戏中包含的立绘、音乐、文本、程序等全部内容的著作权归原著作权人（上海英澈网络科技有限公司）及相关权利人所有；本项目不对这些内容主张任何权利。
- **下载后请于 24 小时内自行删除**。若继续使用，请支持正版游戏。
- 按"现状"提供，不附带任何明示或默示的担保；使用本产物产生的一切后果由使用者自行承担。
- 如果任何权利方认为本仓库内容侵犯了其合法权益，请联系仓库维护者，核实后将立即删除相关内容。
