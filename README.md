...
本仓库是《千年之旅》本地离线学习版的**分发与更新仓库**，只存放发布产物与发版工具，不含游戏源代码。
...
- 在 [Releases](../../releases) 页下载最新 APK，覆盖安装即可，本地存档自动保留在本机。
- 首次启动需要导入原始游戏资源（约 6GB 解压空间）：
  - **本机导入**：自行下载并准备完整的资源压缩包（7z/ZIP），在启动页选择导入；
...
- 如需反馈bug，可以直接在当前仓库页面提交Issues，也可发送至 2523559001@qq.com 。反馈bug时，务必提供**诊断包zip**和**详细且完整的稳定复现bug的步骤方法**，否则作者将无法复现与核查bug根源并修复。
